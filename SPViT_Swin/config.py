...
_C.EXTRA.searching_model = None
_C.EXTRA.assigned_indicators = None

# Architecture hyper-parameters
_C.EXTRA.architecture_lr = 5e-4
_C.EXTRA.arc_decay = 100
_C.EXTRA.arc_warmup = 20
_C.EXTRA.arc_min_lr = 5e-6

# Hyper-parameters
_C.EXTRA.theta = 0.5 # Bernoulli gates' initial parameter
_C.EXTRA.alpha = 1e2 # Softmax temperature for ensembling heads
